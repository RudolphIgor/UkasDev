...
/***/ "./src/js/modules/myscroll.js":
/*!************************************!*\
  !*** ./src/js/modules/myscroll.js ***!
  \************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"slScroll\": () => (/* binding */ slScroll)\n/* harmony export */ });\nconst menuLinks = document.querySelectorAll('.menu__link[data-goto]');\r\n\r\n\r\nfunction slScroll() {\r\n\tconsole.log(menuLinks);\r\n\tif (menuLinks.length > 0) {\r\n\t\tmenuLinks.forEach(element => {\r\n\t\t\telement.addEventListener('click', onMenuLinkClick)\r\n\t\t});\r\n\t}\r\n}\r\n\r\nfunction onMenuLinkClick(e) {\r\n\tconst menuLink = e.target;\r\n\tif (menuLink.dataset.goto && document.querySelector(menuLink.dataset.goto)) {\r\n\t\tconst gotoBlock = document.querySelector(menuLink.dataset.goto);\r\n\r\n\t\tif(gotoBlock.offsetTop > window.pageYOffset){  \r\n\t\t\tdocument\r\n\t\t\t\t\t.documentElement\r\n\t\t\t\t\t.scrollTo(0,gotoBlock.offsetTop );\r\n\t\t}else{\r\n\t\t\tdocument\r\n\t\t\t\t\t.documentElement\r\n\t\t\t\t\t.scrollTo(0,window.gotoBlock.offsetTop);\r\n\t\t}\r\n\t\t\r\n\t\tif(gotoBlock.offsetTop !== window.pageYOffset)requestAnimationFrame(scrollTo)\r\n\t}\r\n\t\te.preventDefault();\r\n\t\r\n}\n\n//# sourceURL=webpack://gulp2022/./src/js/modules/myscroll.js?");
